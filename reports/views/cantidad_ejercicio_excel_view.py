...
class ClasificacionEjercicioUsuariosExcelAPIView(APIView):
    def get(self, request, *args, **kwargs):
        ...
        # Obtener los registros de Ejercicio con los filtros
        ...
        response['Content-Disposition'] = 'attachment; filename=usuarios_ejercicio.xlsx'
        wb.save(response)
