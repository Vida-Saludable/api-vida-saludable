...
class DatosHabitosAireViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        registros_previos = DatosHabitosAire.objects.filter(usuario_id=usuario_id).order_by('-fecha')
        ...
        with transaction.atomic():  # Para asegurar que las actualizaciones sean atómicas
            ...
            if serializer.is_valid():
                ...
                response_data = {
                    ...
                    "message": "Registro de aire creado con éxito.",
                ...
                response_data = {
                    "success": False,
                    "message": "Error al crear el registro de aire.",
...
class ListaDatosHabitosAireUsuarioView(APIView):
    ...
    def get(self, request, usuario_id, *args, **kwargs):
        ...
        if not registros.exists():
            return Response({
                "success": False,
                "message": "No se encontraron registros de hábitos de aire para este usuario."
            }, status=status.HTTP_404_NOT_FOUND)

        # Serializar los datos
        serializer = DatosHabitosAireSerializer(registros, many=True)
        return Response({
            "success": True,
            "data": serializer.data
